...
# Install
    ...
    $ go get github.com/kohkimakimoto/goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `github.com/kohkimakimoto/goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/github.com/kohkimakimoto/goose/lib/goose).
...
import _ "github.com/kohkimakimoto/goose/cmd/goose"
```
